...
import { NavbarColorContext, NavbarContext } from '../../context/NavContaxt'
    ...
    return (
        <div className='z-4 flex fixed top-0 w-full items-start justify-between'>
            ...
            <div onClick={()=>{setNavOpen(true)}} onMouseEnter={() => {
                ...
                className="lg:h-13 h-12 bg-black relative lg:w-[16vw] w-50">
                <div ref={navGreenRef} className='bg-[#D3FD50] transition-all absolute top-0 h-0 w-full'>
                    <div className='relative h-full lg:px-8 px-6 flex flex-col justify-center items-end lg:gap-1.5 gap-1'>
                        <div className="lg:w-16 w-12 h-0.5 bg-white">
                            <div ref={navGreenRef} className='w-full h-full bg-black'></div>
                        </div>
                        <div className="lg:w-11 w-7 h-0.5 bg-white">
                            <div ref={navGreenRef} className='w-full h-full bg-black'></div>
                        </div>
                    </div>
                </div>
